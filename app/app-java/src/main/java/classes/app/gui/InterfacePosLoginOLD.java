...
public class InterfacePosLoginOLD extends javax.swing.JFrame {

    public InterfacePosLoginOLD() {
    initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfacePosLoginOLD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfacePosLoginOLD().setVisible(true);
            }
        });
    }
